...
public class HumansAndDogs extends JFrame {
	...
	public HumansAndDogs() {
		...
		btnNewHuman.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (humanname.getText().length()>=3){
					humans = new Human (humanname.getText()); //Skriver ut rätt info
					error.setText("");	
				}
				
				else{
					error.setText("Invalid name for human"); //Skriver ut felmeddelande
		...
		btnNewHuman.setBackground(new Color(51, 130, 55));
		...
		btnBuyDog.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (humans!=null){
		    	  ...
		    	  error.setText("Dog needs to have a human owner");
			}
			}
		});
		btnBuyDog.setForeground(Color.WHITE);
		btnBuyDog.setBackground(new Color(51, 130, 55));
		...
		btnPrintInfo.setBackground(new Color(51, 130, 55));
